...
import { ImageUploadZone } from "@/components/documents/image-upload-zone";
...
export function DocumentsContent({
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => loadDocuments(true), 15000);
    ...
    <div className="space-y-8 pb-8">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 max-w-xl text-brand-muted-gray">
            {canManage
              ? "Como administrador puedes subir PDFs, videos e imágenes para tu equipo."
              : "Consulta los manuales, videos e imágenes que tu empresa ha publicado."}
          </p>
        </div>
        {documents.length > 0 && (
          <div className="flex gap-3 text-sm">
            ...
            <div className="flex items-center gap-2 rounded-2xl bg-white px-4 py-2 shadow-sm ring-1 ring-black/5">
              ...
              <span className="text-brand-muted-gray">imágenes</span>
            </div>
            <div className="flex items-center gap-2 rounded-2xl bg-white px-4 py-2 shadow-sm ring-1 ring-black/5">
      ...
      {canManage && (
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <ImageUploadZone onUploaded={loadDocuments} />
        </div>
      )}

      {images.length > 0 && (
        <div>
          <h2 className="mb-4 font-heading text-lg font-semibold">Imágenes</h2>
          <DocumentList
            documents={images}
            ...
            emptyDescription="Tu administrador publicará material visual aquí."
          />
        </div>
      )}
          ...
          <CardContent className="flex items-center gap-4 pt-6">
            ...
            <div>
              ...
              <p className="text-sm text-brand-muted-gray">
                Los PDFs procesados alimentan al mentor. Videos e imágenes se
                sirven optimizados desde CDN cuando Cloudinary está activo.
              </p>
            </div>
          </CardContent>
        </Card>
