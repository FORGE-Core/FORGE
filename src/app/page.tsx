        ...
        <section className="relative overflow-hidden px-6 pb-24 pt-28 md:pt-32">
          ...
          <div className="relative mx-auto max-w-5xl text-center">
            <span className="inline-block animate-in fade-in slide-in-from-bottom-2 rounded-full border border-brand-lavender/30 bg-white px-4 py-1.5 text-xs font-medium text-brand-cobalt duration-500">
              Capacitación empresarial · IA · Inclusión
            </span>
            ...
            {/* ── Dos rutas de acceso ───────────────────────────── */}
            <div className="mt-12 grid gap-4 sm:grid-cols-2 max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-3 duration-700 fill-mode-both">

              {/* Acceso estándar */}
              <div className="flex flex-col gap-3 rounded-2xl border border-black/8 bg-white p-6 text-left shadow-sm">
                <p className="text-xs font-semibold uppercase tracking-wide text-brand-muted-gray">Acceso estándar</p>
                <p className="text-sm text-brand-muted-gray">Para usuarios sin necesidades especiales de accesibilidad.</p>
              ...
              {/* Acceso inclusivo */}
              <div className="relative flex flex-col gap-3 overflow-hidden rounded-2xl border-2 border-brand-cobalt/30 bg-brand-cobalt/5 p-6 text-left">
                <div className="pointer-events-none absolute -right-6 -top-6 h-24 w-24 rounded-full bg-brand-cobalt/10" />
                <p className="text-xs font-semibold uppercase tracking-wide text-brand-cobalt">Acceso inclusivo</p>
                <p className="text-sm text-brand-muted-gray">
                  Para personas con baja visión o ceguera. Activa lectura por voz y micrófono sin instalar nada.
                </p>
                <div className="pt-1">
                  <Link
            ...
            <p className="mt-6 animate-in fade-in text-xs text-brand-muted-gray duration-1000 fill-mode-both">
              ¿Quieres ver cómo funciona?{" "}
              <Link
                href="mailto:demo@forge.app?subject=Solicitar%20demo"
                className="font-medium text-brand-cobalt hover:underline"
              >
                Solicita una demo
              </Link>
            </p>
        ...
        <section id="how" className="border-y border-black/5 bg-white px-6 py-20">
          <div className="mx-auto max-w-6xl">
            ...
            <ol className="mt-16 grid gap-8 md:grid-cols-4">
              {[
                { step: "1", title: "Sube documentos",    desc: "Manuales, procesos y videos de tu operación." },
                { step: "2", title: "IA genera contenido", desc: "Módulos, quizzes y simulaciones desde tu documentación." },
                { step: "3", title: "Capacita al equipo",  desc: "Cada persona aprende con NOVA, adaptado por ALAE." },
                { step: "4", title: "Mide resultados",     desc: "Reportes de progreso, inclusión y patrones de aprendizaje." },
              ].map((item) => (
                <li
                  key={item.step}
