...
import type { getDashboardData } from "@/lib/analytics/dashboard";
          ...
          <CardContent className="space-y-3">
            {data.recentActivity.length === 0 ? (
              ...
              data.recentActivity.map((item, i) => (
                <div
                  key={item.id}
                  className="flex gap-3 rounded-2xl bg-brand-light-bg px-4 py-3 animate-in fade-in slide-in-from-left-2 duration-300 fill-mode-both"
